        ...
        <div id="wrapper" style="width: 100%; word-break: break-all">
            ...
            <div id="content-wrapper" style="background-color: rgb(43,43,43); min-width: 1660px">
                <div class="col-md-12" style="color: white;">
                    ...
                    <div class="card mb-3" style="background-color: rgb(245,247,251);" runat="server" id="divApiList">
                        <div class="card-header flex-row align-items-center justify-content-between bg-gradient-primary" style="color: white; background-color: rgb(22,87,217)">
                        ...
                        <div class="card-body" style="color: black; width: 100%; font-size: 13px;">
                            ...
                            <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView ID="grdApiList" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-dark" Font-Size="11px">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="데이터셋명" DataField="API_NAME" />
                                            <asp:BoundField HeaderText="데이터수집처" DataField="API_Data_Collection" />
                                            <asp:BoundField HeaderText="제공기관" DataField="API_Data_Service" />
                                            <asp:BoundField HeaderText="사용목적" DataField="API_Purpose" />
                                            <asp:BoundField HeaderText="수집주기" ItemStyle-Width="70px" DataField="API_Collection_Cycle" />
                                            <asp:BoundField HeaderText="생성자" ItemStyle-Width="60px" DataField="USER_NAME" />
                                            <asp:BoundField HeaderText="생성일자" ItemStyle-Width="100px" DataField="API_CreateDt" />
