        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" style="background-color: rgb(43,43,43);min-width:1660px">
                <div class="container-fluid" style="font-size: 12px">
                    ...
                    <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="card border-0 mb-3" style="background-color: rgb(62,62,62); color: white;" runat="server" id="dvGrid">
                                ...
                                <div class="card-body">
                                    <asp:GridView ID="grdDomain" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-dark">
                                        <HeaderStyle Font-Bold="true" Font-Size="13px" />
                                        <Columns>
                                            <asp:BoundField HeaderText="도메인 명" DataField="DATA_SE_NAME" ItemStyle-Width="200px" />
                                            <asp:BoundField HeaderText="테이블 명" DataField="TABLE_NAME_KOR" ItemStyle-Width="250px" />
                                            <asp:BoundField HeaderText="데이터 건수" DataField="ROWS" ItemStyle-Width="150px" DataFormatString="{0:n0}"/>
                                            <asp:BoundField HeaderText="데이터 용량(KB)" DataField="TABLE_SIZE" ItemStyle-Width="150px" DataFormatString="{0:#,###}" />
                                            <asp:BoundField HeaderText="설명" DataField="TABLE_DESCRIPTION" />
                                            <asp:BoundField HeaderText="수집 주기" DataField="CYCLE_NAME" ItemStyle-Width="150px" />
                                        </Columns>
                                    </asp:GridView>
                                    <asp:GridView ID="grdDetail" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-dark">
                                        <HeaderStyle Font-Bold="true" Font-Size="13px" />
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="데이터셋 명" DataField="TABLE_NAME_KOR" />
                                            <asp:BoundField HeaderText="데이터 건수" DataField="ROWS" ItemStyle-Width="150px" DataFormatString="{0:#,###}" />
                                            <asp:BoundField HeaderText="데이터 용량(KB)" DataField="TABLE_SIZE" ItemStyle-Width="150px" DataFormatString="{0:#,###}" />
                                            <asp:BoundField HeaderText="설명" DataField="TABLE_DESCRIPTION" />
                                            <asp:BoundField HeaderText="수집 주기" DataField="CYCLE_NAME" ItemStyle-Width="150px" />
                                        </Columns>
